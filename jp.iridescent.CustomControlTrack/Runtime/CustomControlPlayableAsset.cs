...
namespace Iridescent.Timeline
{
    ...
    [Serializable]
    [NotKeyable]
    public class CustomControlPlayableAsset : PlayableAsset, IPropertyPreview, ITimelineClipAsset
    {
        ...
        /// </summary>
        [SerializeField] public bool stopOnPauseEvent = false;
            ...
            List<Playable> outplayables, bool disableSelfReferences)
        {
            foreach (var director in directors)
            {
                if (director != null)
                {
                    ...
                    {
                        outplayables.Add(CustomDirectorControlPlayable.Create(graph, director, stopOnPauseEvent));
