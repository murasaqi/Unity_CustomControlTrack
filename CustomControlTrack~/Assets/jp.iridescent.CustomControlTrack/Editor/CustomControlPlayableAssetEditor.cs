...
{
    [CustomTimelineEditor(typeof(CustomControlPlayableAsset))]
    class CustomControlPlayableAssetEditor : ClipEditor
    {
        static readonly Texture2D[] s_ParticleSystemIcon = {AssetPreview.GetMiniTypeThumbnail(typeof(ParticleSystem))};

        public override ClipDrawOptions GetClipOptions(TimelineClip clip)
        {
            var asset = (CustomControlPlayableAsset) clip.asset;
